...
| 2026-08-09 | Escala de radio + SISTEMA-DISENO.md | **ZONA COMPARTIDA: `globals.css` y `tailwind.config.js`.** Se definen `--sdm-radio-control` 2px, `--sdm-radio-contenedor` 4px y `--sdm-radio-flotante` 8px. NO se migran los 155 casos sueltos: solo se aplican donde ya coinciden. Y se crea `SISTEMA-DISENO.md` como referencia del sistema | En curso |
| — | Sofía / chatbot | — | — |
