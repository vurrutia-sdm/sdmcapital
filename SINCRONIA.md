...
| 2026-08-09 | Tokens que faltan + barrido de --green | **ZONA COMPARTIDA: `globals.css` y `tailwind.config.js`.** (1) `.section-label` y los 25 `--green` sobre claro pasan a `--green-dark` — 2,93:1 no cumplía AA. (2) Tokens de peso tipográfico. (3) Tokens de movimiento. (4) La cola del radio de Captación y SearchBar se alinea a la escala | En curso |
| — | Sofía / chatbot | — | — |
