...
| 2026-08-09 | Tokens que faltan + barrido de --green | **ZONA COMPARTIDA cerrada.** 29 usos de  sobre claro a  (2,93 → 4,85:1), incluida . Tokens de peso (3, sin 600/700 porque Inter no los carga y son negrita sintética) y de movimiento (3 duraciones + 1 curva). La cola del radio de Captación y SearchBar alineada. La escala de ESPACIADO no se define: 1.619 literales, ver SISTEMA-DISENO.md 1.6 | Cerrado |
| — | Sofía / chatbot | — | — |
