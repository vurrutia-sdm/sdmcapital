  ...
  return (
    <div className="min-h-screen">
      ...
      <div style={{ ...sp, paddingTop: 80, paddingBottom: 80, background: 'var(--navy-dark)', borderBottom: '1px solid #e8edf2' }}>
        ...
        <p className="font-light mt-6 border-l-2 pl-4" style={{ fontSize: 17, color: 'rgba(255,255,255,0.55)', lineHeight: 1.9, borderColor: 'var(--green)', maxWidth: 520 }}>
          {lang === 'es'
      ...
      <section style={{ ...sp, paddingTop: 80, paddingBottom: 80, borderBottom: '1px solid #e8edf2' }}>
        ...
        <h2 className="font-serif font-light mb-16" style={{ fontSize: 'clamp(28px,5vw,48px)', color: 'var(--navy-dark)', lineHeight: 1.08, letterSpacing: '-0.5px' }}>
      ...
      <section style={{ ...sp, paddingTop: 80, paddingBottom: 80, borderBottom: '1px solid #e8edf2', background: 'var(--off)' }}>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          <div>
            ...
            <h2 className="font-serif font-light mb-8" style={{ fontSize: 'clamp(28px,5vw,44px)', color: 'var(--navy-dark)', lineHeight: 1.1, letterSpacing: '-0.5px' }}>
                ...
                <div className="p-6 lg:p-8">
                  ...
                  {m.whatsapp && (
                    <a href={`https://wa.me/${m.whatsapp}?text=Hola ${m.nombre}, me contacto desde SDM Capital`}
                      ...
                      className="inline-flex items-center gap-2 mt-4 px-4 py-2 rounded-sm"
                      style={{ background: '#25D366', color: '#fff', textDecoration: 'none', fontSize: 12, fontWeight: 600, letterSpacing: '1px', textTransform: 'uppercase' }}
                    >
