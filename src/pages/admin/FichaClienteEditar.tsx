    ...
    <div style={{ minHeight: '100vh', background: 'var(--off)', fontFamily: 'inherit' }}>
      ...
      {loading ? (
        ...
        <div style={{ maxWidth: 860, margin: '0 auto', padding: '32px 24px 80px' }}>
          ...
          {/* `--error` y no `var(--error)`: el literal daba 4,45:1 sobre este fondo y
          ...
          {saveError && (
            <div className="text-sdm-base" style={{ background: 'var(--error-fondo)', border: '1px solid var(--error)', borderRadius: 4, padding: '12px 16px', marginBottom: 16, color: 'var(--error)' }}>
              {saveError}
            </div>
          )}
