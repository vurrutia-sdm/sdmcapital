// Cloudflare Pages Function: Open Graph para /blog
//
...
export async function onRequestGet(context) {
  ...
  try {
    const c = await leerContenido(supabaseUrl, anon, ['blog_subtitulo'])
    const meta = {
      title: 'Blog',
      description: c.blog_subtitulo || 'Artículos sobre mercado inmobiliario, financiamiento hipotecario e inversión en Chile.',
      url: `${BASE_URL}/blog`,
    }
